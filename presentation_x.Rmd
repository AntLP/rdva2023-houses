...
En réalité un l'output d'un modèle de vectorisation de mots va plus ressembler à ça:

1. Nécessite plusieurs centaines de dimensions pour adéquatement encoder la complexité du langage
2. Les différentes dimensions ne sont pas du tout interprétables - Crées avec des réseau de neuronnes

Ces modèles nécessitent extrêmement beaucoup de données pour les entraîner, donc ici je me suis penché vers un modèle générique déjà entraîné
